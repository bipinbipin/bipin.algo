...
public class TwentyTwentyOne_Day5 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < inputArray.length; i++) {
            String[] posArray = inputArray[i].split("->");
            String[] pos1 = posArray[0].trim().split(",");
            String[] pos2 = posArray[1].trim().split(",");
            Line line = new Line();
            line.x1 = Integer.parseInt(pos1[0]);
            line.y1 = Integer.parseInt(pos1[1]);
            line.x2 = Integer.parseInt(pos2[0]);
            line.y2 = Integer.parseInt(pos2[1]);
        ...
        for(Line line : lineList) {
            ...
            if (line.x1 == line.x2) { // horizontal
                if (line.y2 > line.y1) { // left to right
                    int c = line.y1;
                    while (c <= line.y2) {
                        ventMap[line.x1][c]++;
                        c++;
                ...
                if (line.x2 > line.x1) { // bottom to top
                    int c = line.x1;
                    while (c <= line.x2) {
                        ventMap[c][line.y1]++;
                        c++;
...
//                System.out.print(ventMap[x][y] + " ");
    ...
    static String input = "911,808 -> 324,221\n" +
            "161,890 -> 808,243\n" +
            "174,59 -> 174,760\n" +
            "983,983 -> 10,10\n" +
            "321,12 -> 870,12\n" +
